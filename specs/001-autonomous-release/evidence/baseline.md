...
2026-09-07. Actual worktree `<repo>`,
...
existing linked worktree, common repository `<workspace>/.git`,
...
- Initial attempted command: `<workspace>/.venv/bin/python -m
...
- Corrected: `<workspace>/.venv/bin/python -m pytest app/tests -q`.
