...
| Total | 100 | — | 44.5 | User-facing estimate: roughly 45% (44.5 unrounded); the design gate is closed while T018/T025/T087 and complete journey gates stay open. 2026-09-13 recalibrations: growth 0.00→0.30 (audited offline US4–US6 engine chain) and graph/design 0.07→0.20 (audited offline design arc: generate→criticize→pool→approve→prepare with bounded supplementation), while storage/UI/E2E/live majorities stay open in both |
