...
`DEEPTWIN_LIVE_WORK=specified` (attempts 5-8) runs the SAME arc over a DIFFERENT, better-specified
...
def test_one_live_design_arc_to_owner_selection(tmp_path):
    ...
    with owner_app(tmp_path, executor) as subject:
        ...
        observed = {
            ...
            "work": ({"scenario": "specified (attempts 5-8): release notes from one stored changelog",
