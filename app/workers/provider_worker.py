"""Fixed private provider worker image entrypoint (Task 33).
`main()` parses only the fixed argv, opens one private provider service and
...
from .provider_service import ProviderServiceError, open_provider_worker_service
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        return EXIT_ARGV
    try:
        service = open_provider_worker_service(
