...
from ..domain.events import EVENT_TYPES, event_metadata
...
def render_sse(page):
    ...
    if page.gap is not None:
        if (page.gap.reason not in GAP_REASONS
                or type(page.gap.from_sequence) is not int or page.gap.from_sequence < 1
