...
def create_app(data_dir, *, deployment_config, session_root_dir, expected_uid, expected_gid,
               ...
               recovery_trust_set=None, credential_gateway=None, backup_worker=None):
    ...
    try:
        ...
        publication = compose_first_party(application, ApplicationContext(
            ...
            credential_gateway=credential_attachment, backup_worker=backup_client))
...
def main():
    ...
    application = create_app(args.data_dir, deployment_config=configuration,
        ...
        recovery_trust_set=trust_set, credential_gateway=credential_gateway, backup_worker=backup_worker)
